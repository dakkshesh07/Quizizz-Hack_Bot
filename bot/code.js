if (window.location.href.search("quizizz.com/join/game/") == -1 && window.location.href.search("gameType=") == -1) {
    if (window.location.href.search("quizizz.com/join/pre-game/") != -1) {
        alert("You cannot execute this while paused. If you are not paused please DM Dakkshesh on discord!")
        throw new Error("You cannot execute this while paused. If you think this is an error please DM Dakkshesh on discord!");
        ...
        alert("You aren't on a quizizz quiz. If you think this is an error please DM Dakkshesh on discord!")
        throw new Error("You aren't on a quizizz quiz. If you think this is an error please DM Dakkshesh on discord!");
    }
}
...
let WaitTime = prompt("Script by dakkshesh, Please enter the number of seconds to wait before each answer.")
